...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class=" warning_message d-none p-3 mb-2 bg-danger  text-white rounded text-center"> </div>
                <div class="card">
                            ...
                            @auth
                                <div class="form text-center mb-2">
                                    ...
                                    <span class="text-muted mb-3"><input class="form-control d-inline mx-auto" id="quantity"
                                            ...
                                            max="{{ $book->number_of_copies }}" style="width:10%;" required></span>
                                    <button type="submit" class="btn bg-cart addCart me-2"><i class="fa fa-cart-plus"></i> أضف
                                        للسلة</button>
                                </div>
                            @endauth
                            <hr>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.message) {
                        ...
                        $('.warning_message').text(data.message);
                    } else {
