<div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                value="{{ $book->title ?? '' }}" autocomplete="title">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="isbn" type="text" class="form-control @error('isbn') is-invalid @enderror" name="isbn"
                value="{{ $book->isbn ?? '' }} " autocomplete="isbn">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            ...
            <img id="cover-image-thumb" class="img-fluid img-thumbnail" 
                {{ $book != null ? 'src="' . asset('storage/' . $book->cover_image) . '"' : 'src=""' }}>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="publish_year" type="number" class="form-control @error('publish_year') is-invalid @enderror"
