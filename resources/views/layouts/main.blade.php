...
<head>
    ...
    <title>مكتبة ابو العز</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">

    <link href="{{ asset('build/assets/app-8bc5930c.css') }}" rel="stylesheet">
    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">مكتبة ابو العز</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item dropdown justify-content-left text-right">
        ...
        <main class="py-4">
            <div class="container-fluid">
                {{-- @if (Session::has('ww'))
                    <div class="p-3 z-20 mb-2 bg-success text-white rounded text-center">
                        {{ session('ww') }}
                    </div>
                @endif --}}
                @yield('content')
